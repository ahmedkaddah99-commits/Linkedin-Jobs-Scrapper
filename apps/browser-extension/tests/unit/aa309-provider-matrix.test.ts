...
const PROVIDERS: ReadonlyArray<{
  ...
  {
    provider: "workday",
    fixture: "workday-application.html",
  ...
  },
  {
    ...
    fixture: "smartrecruiters-application.html",
    url: "https://jobs.smartrecruiters.com/Acme/74400",
    expected: { firstName: "Alex", lastName: "Fixture", email: "alex.fixture@example.com" },
  },
  {
    provider: "ashby",
    fixture: "ashby-application.html",
  ...
  {
    provider: "bamboohr",
    fixture: "bamboohr-application.html",
    url: "https://acme.bamboohr.com/careers/42",
    expected: { firstName: "Alex", lastName: "Fixture", email: "alex.fixture@example.com" },
  },
  {
    provider: "jobvite",
    fixture: "jobvite-application.html",
    url: "https://jobs.jobvite.com/acme/job/oX0/apply",
    expected: { firstName: "Alex", lastName: "Fixture", email: "alex.fixture@example.com" },
  },
  {
    provider: "recruitee",
    fixture: "recruitee-application.html",
