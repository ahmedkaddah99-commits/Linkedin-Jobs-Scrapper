...
class ReusablePackageServiceTests(unittest.TestCase):
    ...
    def test_stage2_pipeline_runs_in_memory(self):
        ...
        temp_dir = self._workspace_tempdir("reusable_stage2_service")
    ...
    def test_stage4_and_stage5_run_in_memory(self):
        config = load_reusable_packages_config()
        temp_dir = self._workspace_tempdir("reusable_stage45_service")
        jobs = [
            {
