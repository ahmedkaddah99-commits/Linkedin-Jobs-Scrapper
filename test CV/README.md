...
- Current reusable role CV files copied from the repo: 18
- Current job-specific tailored CV files copied from the repo: 78
- Built-in style matrix generated from the current renderer: 120 docx files (4 templates x 6 color schemes x 5 fonts)
- Web-inspired print-ready HTML templates: 15
