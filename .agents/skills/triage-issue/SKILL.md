...
Use the Agent tool with subagent_type=Explore to deeply investigate the codebase when the agent environment supports it. In Cline or another environment without subagents, perform the investigation yourself before filing. Your goal is to find:
