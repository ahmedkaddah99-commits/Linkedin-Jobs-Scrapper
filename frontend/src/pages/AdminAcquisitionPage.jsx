...
function Jobs({ data, request, onMessage, onInspect }) {
  const [draft, setDraft] = useState({ search: "", source: "", completeness_state: "", publication_state: "" });
...
export default function AdminAcquisitionPage() {
  ...
  const content = section === "overview" ? <Overview data={data} navigate={navigate} /> : section === "sources" ? <Sources data={data} request={request} onMessage={setMessage} /> : section === "jobs" ? <Jobs data={data} request={request} onMessage={setMessage} onInspect={inspectJob} /> : section === "duplicates" ? <Duplicates data={data} /> : section === "companies" ? <Companies data={data} request={request} onMessage={setMessage} /> : section === "rules" ? <Rules data={data} /> : section === "reprocessing" ? <Reprocessing data={data} request={request} onMessage={setMessage} /> : <Publication data={data} request={request} onMessage={setMessage} />;
