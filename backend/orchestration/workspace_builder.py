...
def _configuration_fields() -> list[dict]:
    return [
        ...
        {
            "id": "company_site_emergency_max_job_links_per_site",
            "label": "Company Site Emergency Ceiling",
            "description": "Defensive ceiling used only for pathological company sites.",
            "type": "number",
            "compatible_flows": [FLOW_TAILORED_DOCUMENTS],
            "source_ids": [SOURCE_COMPANY_CAREER_SITES, SOURCE_ACADEMIC_CAREER_SITES],
            "placeholder": "75",
