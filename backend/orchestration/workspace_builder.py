...
FIELD_SECTION_BY_ID = {
    ...
    "german_special_char_threshold": "filters",
...
FIELD_SORT_ORDER = {
    ...
    "country_codes": 32,
    "cities": 34,
    "company_site_locality_mode": 145,
    "job_filtering_mode": 35,
    "time_posted_seconds": 40,
    "posted_within_days": 40,
    "experience_levels": 50,
    "forbidden_title_keywords": 60,
    "german_special_char_threshold": 70,
    "max_german_level": 80,
    "french_special_char_threshold": 90,
    "spanish_special_char_threshold": 100,
    "low_applicant_threshold": 110,
    "languages": 120,
    "manual_url_seed_list": 130,
    "academic_career_sites": 140,
    "company_career_sites": 150,
    "portals": 160,
    "cv_template": 170,
    "cv_color_scheme": 180,
    "cv_font": 190,
    "include_photo": 200,
    "stage1_model": 210,
    "stage1_extra_prompt": 220,
    "stage1_prompt_override": 230,
    "stage4_model": 240,
    "stage4_fallback_model": 250,
    LIGHT_CUSTOMIZATION_EXTRA_PROMPT_FIELD: 255,
    LIGHT_CUSTOMIZATION_PROMPT_OVERRIDE_FIELD: 256,
    AGGRESSIVE_CUSTOMIZATION_EXTRA_PROMPT_FIELD: 257,
    AGGRESSIVE_CUSTOMIZATION_PROMPT_OVERRIDE_FIELD: 258,
    "stage4_max_jobs": 260,
    "stage4_extra_prompt": 270,
    "stage4_prompt_override": 280,
}
...
def _configuration_fields() -> list[dict]:
    return [
        ...
        },
        {
            ...
            "description": "Allow proxy fallback when LinkedIn or pasted job URL enrichment fails.",
            "type": "boolean",
            "compatible_flows": [FLOW_TAILORED_DOCUMENTS],
            "source_ids": [
        ...
        },
        {
            ...
            "description": "Use the saved university and department website list for academic roles, and add up to 50 university, chair, department, institute, or research portal URLs of your own. Academic site fetching now runs through ScrapeOps only.",
        ...
        },
        {
            ...
            "label": "Academic Legacy Jobs Per Site Cap",
            "description": "Legacy compatibility field. Leave this at 0 so academic sites are not silently truncated after 10 jobs.",
            "type": "number",
            "compatible_flows": [FLOW_TAILORED_DOCUMENTS],
            "source_ids": [SOURCE_ACADEMIC_CAREER_SITES],
            "placeholder": "0",
        ...
        },
        {
            ...
            "description": "Search company career sites with local-market-first filtering, and add up to 50 company or careers URLs of your own. Separate each URL with Enter or a comma. Company site fetching now runs through ScrapeOps only.",
            "type": "company_site_list",
            "compatible_flows": [FLOW_TAILORED_DOCUMENTS],
        ...
        {
            "id": "company_site_locality_mode",
            "label": "Company Site Market Scope",
            "description": "Prefer pages and jobs aligned to the workspace target country. Use strict mode when you want local-only sourcing even for international companies.",
            "type": "select",
            "compatible_flows": [FLOW_TAILORED_DOCUMENTS],
            "source_ids": [SOURCE_COMPANY_CAREER_SITES, SOURCE_ACADEMIC_CAREER_SITES],
            "options": [
                {"value": "local_preferred", "label": "Local preferred"},
                {"value": "strict_local_only", "label": "Strict local only"},
            ],
            "default": "local_preferred",
        },
        {
            "id": "company_site_max_jobs_per_site",
            "label": "Company Legacy Jobs Per Site Cap",
            "description": "Legacy compatibility field. Leave this at 0 so relevant company sites are not silently truncated after 10 jobs.",
            "type": "number",
            "compatible_flows": [FLOW_TAILORED_DOCUMENTS],
            "source_ids": [SOURCE_COMPANY_CAREER_SITES],
            "placeholder": "0",
        ...
        {
            "id": "company_site_max_sites_per_run",
            "label": "Company Site Plan Limit",
            "description": "Policy-managed per-run cap injected from the authenticated plan.",
            "type": "number",
            "compatible_flows": [FLOW_TAILORED_DOCUMENTS],
            "source_ids": [SOURCE_COMPANY_CAREER_SITES, SOURCE_ACADEMIC_CAREER_SITES],
            "placeholder": "0",
        ...
        {
            "id": "company_site_runner_credit_budget",
            "label": "Company Site Runner-Credit Budget",
            "description": "Policy-managed runner-credit budget injected from the authenticated plan.",
            "type": "number",
            "compatible_flows": [FLOW_TAILORED_DOCUMENTS],
            "source_ids": [SOURCE_COMPANY_CAREER_SITES, SOURCE_ACADEMIC_CAREER_SITES],
            "placeholder": "0",
        ...
        {
            "id": "company_site_max_job_links_per_site",
            "label": "Company Site Job Link Cap",
            "description": "Maximum job links fetched from each company or academic site. Runs report any site where this limit prevents complete coverage.",
            "type": "number",
            "compatible_flows": [FLOW_TAILORED_DOCUMENTS],
            "source_ids": [SOURCE_COMPANY_CAREER_SITES, SOURCE_ACADEMIC_CAREER_SITES],
            "placeholder": "25",
        ...
        {
            "id": "company_site_policy_version",
            "label": "Company Site Policy Version",
            "description": "Internal policy snapshot stored with the run.",
            "type": "text",
            "compatible_flows": [FLOW_TAILORED_DOCUMENTS],
            "source_ids": [SOURCE_COMPANY_CAREER_SITES, SOURCE_ACADEMIC_CAREER_SITES],
            "frontend_visible": False,
        ...
        {
            "id": "german_special_char_threshold",
            "label": "Reject German-language Jobs",
            "description": "Enable or disable German-language rejection when German is not listed in the baseline CV language lines.",
            "type": "select",
            "compatible_flows": [FLOW_TAILORED_DOCUMENTS],
            "source_ids": [
                SOURCE_LINKEDIN_SEARCH,
            ...
            "options": [
                {"value": 0, "label": "Yes - exclude German jobs"},
                {"value": 9999, "label": "No - allow German jobs"},
            ],
            "default": 9999,
        },
        {
        ...
        },
        {
            ...
            "label": "Job Posted Within",
            "description": "Choose the oldest posting age to include. A wider window also includes all newer jobs; for example, Last week includes a job posted 2 days ago.",
            "type": "select",
            "compatible_flows": [FLOW_TAILORED_DOCUMENTS, FLOW_REUSABLE_PACKAGES],
            "source_ids": [
                SOURCE_MULTI_PORTAL,
            ...
            "options": [
                {"value": 0, "label": "Any time (includes 2+ months)"},
    ...
    return BuilderCatalog(
        ...
        sources=[
            ...
            },
            {
                ...
                "name": "Academic Jobs",
                "description": "Search university, department, chair, institute, and research-site openings with target-market filtering and ScrapeOps usage controls.",
                "compatible_flows": [FLOW_TAILORED_DOCUMENTS],
            },
            {
                ...
                "description": "Search company career sites with local-market-first filtering and plan-aware ScrapeOps limits.",
                "compatible_flows": [FLOW_TAILORED_DOCUMENTS],
            },
            {
