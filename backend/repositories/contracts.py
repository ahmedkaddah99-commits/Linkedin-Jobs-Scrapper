...
class AcquisitionStoreProtocol(Protocol):
    ...
    def claim_due_cycle(self, *, window_key: str, lease_owner: str, scheduled_at: str, lease_seconds: int = 300, force: bool = False, manifest_version: str = "", scope_key: str = "") -> dict[str, Any] | None: ...
    ...
    def claim_next_task(self, *, cycle_id: str, lease_owner: str, lease_seconds: int = 300, cycle_lease_token: str = "", max_attempts: int = 3) -> dict[str, Any] | None: ...
    def heartbeat_cycle(self, cycle_id: str, *, lease_owner: str, lease_token: str, lease_seconds: int = 300) -> bool: ...
    def heartbeat_task(self, task_id: str, *, lease_owner: str, lease_token: str, attempt_count: int, lease_seconds: int = 300) -> bool: ...
    def assert_task_lease(self, task_id: str, *, lease_owner: str, lease_token: str, attempt_count: int | None = None) -> None: ...
    def reserve_request(self, **kwargs: Any) -> dict[str, Any]: ...
    def mark_request_dispatching(self, request_id: str, **kwargs: Any) -> None: ...
    ...
    def complete_task(self, task_id: str, *, status: str, result: Mapping[str, Any], error_code: str = "", error_message: str = "", lease_owner: str = "", lease_token: str = "", attempt_count: int | None = None) -> None: ...
    def complete_cycle(self, cycle_id: str, *, status: str, error_code: str = "", error_message: str = "", publication_id: str = "", lease_owner: str = "", lease_token: str = "") -> None: ...
    ...
    def restore_publication(self, confirmation: Any) -> str: ...
    ...
    def claim_next_job_import(self, *, lease_owner: str = "runr-worker", worker_role: str = "acquisition") -> dict[str, Any] | None: ...
...
class PersonalizedJobsStoreProtocol(Protocol):
    ...
    def recover_stale_intelligence(self, *, now: str = "", max_attempts: int = 3) -> list[dict[str, Any]]: ...
    def claim_next_intelligence(self, *, worker_role: str = "customer", lease_owner: str = "runr-worker", lease_seconds: int = 300, max_attempts: int = 3) -> dict[str, Any] | None: ...
    def complete_intelligence(self, cache_id: str, *, state: str, payload: Mapping[str, Any], error: str = "", lease_owner: str = "", lease_token: str = "", attempt_count: int | None = None) -> dict[str, Any]: ...
    def enqueue_customer_task(self, *, user_id: str, task_type: str, idempotency_key: str, payload: Mapping[str, Any], max_attempts: int = 3) -> dict[str, Any]: ...
    ...
    def claim_next_customer_task(self, *, worker_role: str = "customer", lease_owner: str = "runr-worker", lease_seconds: int = 300, max_attempts: int = 3) -> dict[str, Any] | None: ...
    def complete_customer_task(self, task_id: str, *, state: str, result: Mapping[str, Any] | None = None, error_code: str = "", error_message: str = "", lease_owner: str = "", lease_token: str = "", attempt_count: int | None = None, retryable: bool = False) -> dict[str, Any]: ...
