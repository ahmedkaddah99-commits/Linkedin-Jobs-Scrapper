...
CV_TEMPLATE_PRESETS = {
    ...
    "modern_minimal": {
        ...
        "description": "Clean one-column PDF template inspired by the modern minimal reference.",
        "layout": "plain_resume",
        "heading_case": "upper",
        "base_font_size": 10.0,
    ...
    "modern_sidebar": {
        ...
        "description": "Two-column PDF template inspired by the modern sidebar reference.",
        "layout": "compact",
        "heading_case": "upper",
        "base_font_size": 10.0,
        "header_font_size": 17.0,
    ...
    "classic_executive": {
        ...
        "description": "Formal executive PDF template inspired by the classic executive reference.",
        "layout": "classic",
        "heading_case": "upper",
        "base_font_size": 10.0,
        "header_font_size": 18.0,
...
CV_TEMPLATE_ALIASES = {
    ...
    "classic-executive": "classic_executive",
}
...
def get_document_design_options() -> dict:
    return {
        "templates": [
            ...
            dict(CV_TEMPLATE_PRESETS["modern_minimal"]),
            dict(CV_TEMPLATE_PRESETS["modern_sidebar"]),
            dict(CV_TEMPLATE_PRESETS["classic_executive"]),
        ],
