...
def build_stage4_args(cli_args) -> SimpleNamespace:
    ...
    return SimpleNamespace(
        ...
        workspace_cv_asset_docx_path=getattr(cli_args, "workspace_cv_asset_docx_path", ""),
        ...
        linkedin_url=getattr(cli_args, "linkedin_url", ""),
        ...
        ats_max_attempts=int(getattr(cli_args, "stage4_ats_max_attempts", 3) or 3),
...
def build_main_defaults(config: dict) -> dict[str, Any]:
    return {
        ...
        "company_site_policy_version": "",
        "scrapeops_domain_policies": [],
        "run_user_plan_id": "",
        "run_user_quota_overrides": {},
        ...
        "stage4_ats_max_attempts": cfg_int(config, ("runtime", "stage4", "ats_max_attempts"), 3),
        ...
        "linkedin_url": cfg_str(config, ("candidate", "profile_links", "linkedin", "url"), ""),
