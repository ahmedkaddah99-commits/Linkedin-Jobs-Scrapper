...
from .support import cfg_str, compact_whitespace, load_blue_collar_config, load_json_file, resolve_path, save_json_file
...
def build_stage5_args(config: dict | None = None, overrides: Mapping[str, Any] | None = None) -> SimpleNamespace:
    ...
    payload = {
        ...
        "output_xlsx": cfg_str(config, ("runtime", "stage5", "output_xlsx"), "outputs/blue_collar_jobs_with_docs.xlsx"),
...
def run_stage5_pipeline(
    ...
    *,
    ...
    for job in jobs:
        ...
        category_name = str(job.get("role_category_name") or "Other Blue-Collar")
        role_cv = role_index.get(category_id) or role_index.get("other_blue_collar") or {}
